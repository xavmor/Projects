...
#elif defined MSP432_HARDWARE
#include "msp.h"
#define i2c_write(a, b, c, d)   I2CWriteMultipleByte(I2CModuleBase, b, d, c)
#define delay_ms(a)    milliDelay(a)
#define i2c_read(a, b, c, d) I2CReadMultipleByte(I2CModuleBase, b, d, c)
#define log_i(...)     do {} while (0)
#define log_e(...)     do {} while (0)
/* labs is already defined by TI's toolchain. */
/* fabs is for doubles. fabsf is for floats. */
...
static inline int reg_int_cb(struct int_param_s *int_param)
{
    /* Configuring P5.5 as an input and enabling interrupts */
    GPIO_setAsInputPinWithPullUpResistor(GPIO_PORT_P5, GPIO_PIN5);
    GPIO_clearInterruptFlag(GPIO_PORT_P5, GPIO_PIN5);
    GPIO_enableInterrupt(GPIO_PORT_P5, GPIO_PIN5);
    Interrupt_enableInterrupt(INT_PORT5);

    return 0;//msp430_reg_int_cb(int_param->cb, int_param->pin, int_param->lp_exit,
        //int_param->active_low);
}
//#else
